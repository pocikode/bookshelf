...
export const AboutWindow = () => {
  ...
  const bookshelfVersion = process.env['NEXT_PUBLIC_BOOKSHELF_VERSION'] ?? '0.1.0';
  const readestVersion = getAppVersion();
  const versionInfo = _(
    'Bookshelf version {{bookshelfVersion}} (based on Readest version {{readestVersion}})',
    {
      bookshelfVersion,
      readestVersion,
    },
        ...
        <div className='about-content flex flex-col items-center justify-center gap-4 pb-10 sm:pb-0'>
          <div className='flex flex-1 flex-col items-center justify-end gap-2 px-8 py-2'>
            ...
            <div className='flex select-text flex-col items-center'>
              <h2 className='mb-2 text-2xl font-bold'>Bookshelf</h2>
              <button
                type='button'
                title={_('Copy')}
