 ...
 * plan-gated helpers, which only check that the token is truthy.
 *
 ...
 * that decodes to an empty payload. It is never sent
 ...
 *
 * Decodes to an empty payload, so access helpers use their default values.
 */
